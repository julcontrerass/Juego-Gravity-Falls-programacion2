...
EstadoDeMapas::EstadoDeMapas() : mapaActual(0), timer(0), click(false)
{
...
void EstadoDeMapas::cambiarMapa(sf::RenderWindow &window)
{
    ...
    ///segundo mapa
    if (!click && mapaActual == 0 && dipperPosprimerMapa.x >= 250 && dipperPosprimerMapa.x <= 400 && dipperPosprimerMapa.y >= 483 && dipperPosprimerMapa.y <= 600)
    {
    ...
    /// octavo mapa
    if (!click && mapaActual == 0 && dipperPosprimerMapa.x >= 170 && dipperPosprimerMapa.x <= 280 && dipperPosprimerMapa.y >= 0 && dipperPosprimerMapa.y <= 250)
    {
        if (sf::Keyboard::isKeyPressed(sf::Keyboard::Space))
        {
            mapaActual = 7;
    ...
    //primer mapa
    if (!click && mapaActual == 1 && dipperPosSegundoMapa.x >= 579 && dipperPosSegundoMapa.x <= 712 && dipperPosSegundoMapa.y >= 570 && dipperPosSegundoMapa.y <= 672)
    {
        if (sf::Keyboard::isKeyPressed(sf::Keyboard::Space))
        {
            mapaActual = 0;
    ...
    // tercer mapa
    if (!click && mapaActual == 1 && dipperPosSegundoMapa.x >= 1330 && dipperPosSegundoMapa.x <= 1500 && dipperPosSegundoMapa.y >= 0 && dipperPosSegundoMapa.y <= 219)
    {
        if (sf::Keyboard::isKeyPressed(sf::Keyboard::Space ))
        {
            mapaActual = 2 ;
    ...
    // cuarto mapa
    if (!click && mapaActual == 1 && dipperPosSegundoMapa.x >= 0 && dipperPosSegundoMapa.x <= 109 && dipperPosSegundoMapa.y >= 866 && dipperPosSegundoMapa.y <= 979)
    {
        if (sf::Keyboard::isKeyPressed(sf::Keyboard::Space))
        {
            mapaActual = 3;
    ...
    //segundo mapa
    if (!click && mapaActual == 2 && dipperPosTercerMapa.x >= 1300 && dipperPosTercerMapa.x <= 1400 && dipperPosTercerMapa.y >= 900 && dipperPosTercerMapa.y <= 2000)
    {
        if (sf::Keyboard::isKeyPressed(sf::Keyboard::Space))
        {
            mapaActual = 1;
    ...
    // sexto mapa
    if (!click && mapaActual == 2 && dipperPosTercerMapa.x >= 1434 && dipperPosTercerMapa.x <= 1492 && dipperPosTercerMapa.y >= 213 && dipperPosTercerMapa.y <= 280)
    {
        if (sf::Keyboard::isKeyPressed(sf::Keyboard::Space))
        {
            mapaActual = 5 ;
    ...
    //segundo mapa
    if (!click && mapaActual == 3 && dipperPosCuartoMapa.x >= 1400 && dipperPosCuartoMapa.x <= 1500 && dipperPosCuartoMapa.y >= 800 && dipperPosCuartoMapa.y <= 900)
    {
        if (sf::Keyboard::isKeyPressed(sf::Keyboard::Space))
        {
            mapaActual = 1;
    ...
    // quinto mapa
    if (!click && mapaActual == 3 && dipperPosCuartoMapa.x >= 1161 && dipperPosCuartoMapa.x <= 1234 && dipperPosCuartoMapa.y >= 0 && dipperPosCuartoMapa.y <= 96)
    {
        if (sf::Keyboard::isKeyPressed(sf::Keyboard::Space))
        {
            mapaActual = 4 ;
    ...
    //cuarto mapa
    if (!click && mapaActual == 4 && dipperPosQuintoMapa.x >= 297 && dipperPosQuintoMapa.x <= 515 && dipperPosQuintoMapa.y >= 523 && dipperPosQuintoMapa.y <= 600)
    {
        if (sf::Keyboard::isKeyPressed(sf::Keyboard::Space))
        {
            mapaActual = 3;
    ...
    // noveno mapa
    if (!click && mapaActual == 4 && dipperPosQuintoMapa.x >= 0 && dipperPosQuintoMapa.x <= 77 && dipperPosQuintoMapa.y >= 271 && dipperPosQuintoMapa.y <= 400)
    {
        if (sf::Keyboard::isKeyPressed(sf::Keyboard::Space))
        {
            mapaActual = 8 ;
    ...
    //tercer mapa
    if (!click && mapaActual == 5 && dipperPosSextoMapa.x >= 130 && dipperPosSextoMapa.x <= 190 && dipperPosSextoMapa.y >= 725 && dipperPosSextoMapa.y <= 800)
    {
    ...
    // septimo mapa
    if (!click && mapaActual == 5 && dipperPosSextoMapa.x >= 1353 && dipperPosSextoMapa.x <= 1434 && dipperPosSextoMapa.y >= 222 && dipperPosSextoMapa.y <= 300)
    {
        if (sf::Keyboard::isKeyPressed(sf::Keyboard::Space))
        {
            mapaActual = 6 ;
    ...
    //segundo mapa
    if (!click && mapaActual == 6 && dipperPosSeptimoMapa.x >= 651 && dipperPosSeptimoMapa.x <= 800 && dipperPosSeptimoMapa.y >= 220 && dipperPosSeptimoMapa.y <= 400)
    {
        if (sf::Keyboard::isKeyPressed(sf::Keyboard::Space))
        {
            mapaActual = 5;
    ...
    //primer mapa
    if (!click && mapaActual == 7 && dipperPosOctavoMapa.x >= 0 && dipperPosOctavoMapa.x <= 800 && dipperPosOctavoMapa.y >= 530 && dipperPosOctavoMapa.y <= 600)
    {
        if (sf::Keyboard::isKeyPressed(sf::Keyboard::Space))
        {
            mapaActual = 0;
    ...
    //quinto mapa
    if ( !click && mapaActual == 8 && dipperPosNovenoMapa.x >= 1102 && dipperPosNovenoMapa.x <= 1220 && dipperPosNovenoMapa.y >= 183 && dipperPosNovenoMapa.y <= 273)
    {
        if (sf::Keyboard::isKeyPressed(sf::Keyboard::Space))
        {
            mapaActual = 4;
